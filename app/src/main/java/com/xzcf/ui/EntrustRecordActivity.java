...
public class EntrustRecordActivity extends BaseActivity {
    ...
    public static Intent startAction(Context context) {
        return new Intent(context, EntrustRecordActivity.class);
    }
    ...
    private void initView() {
        ...
        loadCells(createEnd, createEnd,"1");
    ...
    private void refresh(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                loadCells(DateTimeUtils.addDate(createEnd, Calendar.DATE, -7), createEnd,"2");
                break;
            case 2:
                loadCells(DateTimeUtils.addDate(createEnd, Calendar.MONTH, -1), createEnd,"2");
                break;
            case 3:
                loadCells(DateTimeUtils.addDate(createEnd, Calendar.MONTH, -3), createEnd,"2");
                break;
            case 4:
                loadCells(null, null,"2");
                break;
        }
    }
    ...
    private List<List<String>> entrustRecord2Cells(List<EntrustRecordResponse.LogInfosBean> logInfos) {
        ...
        for (EntrustRecordResponse.LogInfosBean logInfo : logInfos) {
            ...
            cells.add(logInfo.getTimeEntrust().split(" " )[0]);
    ...
    public void loadCells(Date start, Date end,String type) {
        try{
            ...
            mDisposable = DataManager.getInstance()
                    .getEntrustRecord(memberId, "1", start, end,type)
