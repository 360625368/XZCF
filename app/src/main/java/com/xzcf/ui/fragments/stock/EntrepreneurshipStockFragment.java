...
public class EntrepreneurshipStockFragment extends BaseSuperFragment {
    ...
    private final String stockType= "3";

    public static EntrepreneurshipStockFragment newInstance() {
        Bundle args = new Bundle();
        EntrepreneurshipStockFragment fragment = new EntrepreneurshipStockFragment();
