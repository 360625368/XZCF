...
public class KDayChartFragment extends BaseSuperFragment {
    ...
    public static KDayChartFragment newInstance() {
        Bundle args = new Bundle();
        KDayChartFragment fragment = new KDayChartFragment();
    ...
    protected int getLayoutRes() {
        return R.layout.fragment_k_chart_day;
    }
    ...
    public void onDetailClick() {
        ...
        startActivity(StockKChartDetailActivity.newIntent(getActivity(), mIntentBean, 2));
    }
