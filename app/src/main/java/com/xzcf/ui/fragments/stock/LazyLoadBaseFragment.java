...
public abstract class LazyLoadBaseFragment extends Fragment {
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        Logger.e(getClass().getSimpleName() + "  onHiddenChanged dispatchChildVisibleState  hidden " + hidden);
...
//        // 当父 dispatchChildVisibleState 的时候第二次回调本方法 visible = false 所以此处 visible 将直接返回
    ...
    public void onFragmentFirstVisible() {
        Logger.e(getClass().getSimpleName() + "  对用户第一次可见");

    }

    public void onFragmentResume() {
        Logger.e(getClass().getSimpleName() + "  对用户可见");
    }

    public void onFragmentPause() {
        Logger.e(getClass().getSimpleName() + "  对用户不可见");
    }
