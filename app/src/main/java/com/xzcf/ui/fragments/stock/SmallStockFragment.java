...
public class SmallStockFragment extends BaseSuperFragment {
    ...
    private final String stockType= "4";



    public static SmallStockFragment newInstance() {
        SmallStockFragment fragment = new SmallStockFragment();
