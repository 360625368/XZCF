...
public class KMonthChartFragment extends BaseSuperFragment {
    ...
    public static KMonthChartFragment newInstance() {
        Bundle args = new Bundle();
        KMonthChartFragment fragment = new KMonthChartFragment();
    ...
    protected int getLayoutRes() {
        return R.layout.fragment_k_chart_month;
    }
    ...
    public void onDetailClick() {
        ...
        startActivity(StockKChartDetailActivity.newIntent(getActivity(), mIntentBean, 4));
    }
