...
public class MarketFiveSpeedAdapter extends BaseQuickAdapter<StockMarketFiveSpeedBean,BaseViewHolder> {
    ...
    public MarketFiveSpeedAdapter setTodayPrice(Double todayPrice) {
        mTodayPrice = todayPrice;
        return this;
    }

    public MarketFiveSpeedAdapter(@Nullable List<StockMarketFiveSpeedBean> data, Double todayPrice) {
        super(R.layout.item_five_speed,data);
...
//           if (TextUtils.equals(item.getTitle(),"卖一")) {
