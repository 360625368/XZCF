...
public class BuyFiveAdapter extends BaseQuickAdapter<StockMarketFiveSpeedBean,BaseViewHolder> {
    ...
    public BuyFiveAdapter setTodayPrice(Double todayPrice) {
        mTodayPrice = todayPrice;
        return this;
    }

    public BuyFiveAdapter(@Nullable List<StockMarketFiveSpeedBean> data, Double todayPrice) {
